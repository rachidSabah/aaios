...
from services.doctor.models import ScanType, IssueSeverity
from services.self_healing.engine import SelfHealingEngine
from services.self_healing.models import HealingStatus, HealingTrigger
...
from services.update.models import ReleaseChannel, UpdateStatus
from services.validator.manager import ReleaseValidator
from services.monitoring.monitor import ContinuousHealthMonitor
from services.monitoring.models import AlertSeverity, AlertChannel
...
def test_doctor_scan(temp_workspace):
    ...
    assert report.health_score < 100  # Some directories/files should be missing in empty temp workspace
